...
import rollsImage from './images/Rolls.avif';
import rasmalaiImage from './images/Rasmalai.avif';
import pavBhajiImage from './images/Pav_Bhaji.avif';
import pastaImage from './images/Pasta.avif';
import parathaImage from './images/Paratha.avif';
import northIndianImage from './images/North_Indian_4.avif';
import noodlesImage from './images/Noodles.avif';
import momosImage from './images/Momos.avif';
import lassiImage from './images/Lassi.avif';
import idliImage from './images/Idli.avif';
import iceCreamImage from './images/Ice_Creams.avif';
import dosaImage from './images/Dosa.avif';
import choleBhatureImage from './images/Chole_Bature.avif';
import chineseImage from './images/Chinese.avif';
import cakesImage from './images/Cakes.avif';
import burgerImage from './images/Burger.avif';
import biryaniImage from './images/Biryani_2.avif';
import CoffeImage from './images/Coffee.avif';
import GulabjamunImage from './images/Gulab_Jamun.avif';
import ShakesImage from './images/Shakes.avif';
import KhichdiImage from './images/Khichdi.avif';
import RasgullaImage from './images/Rasgulla.avif';
...
const WhatInYourMindCarousel = ({ title }) => {
    ...
    return (
        <div>
            <div className="carousel-containerhp">
                <div className="headerhp">
                    <div className="titlehp">{title}</div>
                    <span className="scroll-arrowhp">
                        <FontAwesomeIcon
                        ...
                        />
                        <FontAwesomeIcon
                            className={`circle ${currentSlide === MAX_RIGHT_CLICK_VALUE ? 'disabled' : ''}`}
                            icon={faArrowRight}
                            onClick={nextSlide}
                        />
                    </span>
                </div>
                <div className="carouselhp">
                    <div className="carousel-innerhp" style={style}>
                        {dishes.map((dish) => (
